class UniversidadesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @universidade.save
          format.html { redirect_to @universidade, notice: 'La universidad fue agregada con exito.' }
  ...
  def update
    respond_to do |format|
      if @universidade.update(universidade_params)
          format.html { redirect_to @universidade, notice: 'La universidad fue actualizada con exito.' }
  ...
  def destroy
    ...
    respond_to do |format|
        format.html { redirect_to universidades_url, notice: 'La universidad fue eliminada con exito.' }
  ...
  private
    ...
    def universidade_params
      params.require(:universidade).permit(:nombre)
    end
end
