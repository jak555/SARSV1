class PaisesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paise.save
          format.html { redirect_to @paise, notice: 'El pais fue agregado con exito.' }
  ...
  def update
    respond_to do |format|
      if @paise.update(paise_params)
          format.html { redirect_to @paise, notice: 'El pais fue actualizado con exito.' }
  ...
  def destroy
    @paise.destroy
    respond_to do |format|
        format.html { redirect_to paises_url, notice: 'El pais fue eliminado con exito.' }
